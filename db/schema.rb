...
ActiveRecord::Schema.define(version: 20151104062813) do
  ...
  add_index "drippers", ["email"], name: "index_drippers_on_email", unique: true
  add_index "drippers", ["reset_password_token"], name: "index_drippers_on_reset_password_token", unique: true
